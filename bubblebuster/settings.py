...
class InterfaceSettings:
    ...
    BACKGROUND_COLOR_LIGHT = (235, 235, 235)

    # FONT SETTINGS
    MOUSEHIGHLIGHTFONTCOLOR = (255, 255, 255)
    MOUSEHIGHLIGHTFONTCOLOR_LIGHT = (200, 200, 200)
...
BUBBLEPOPDELAY = 500
BUBBLE_MAXDELTA = 100
BUBBLE_MAXDELTA_DELTA = 5
BUBBLE_GIFTPROCPROBA = 0.05
BUBBLE_PROCPROBA = 0.05

POINTSLEVEL_TARGETSCORE = 25
MULTIPLIERLEVEL_TARGETMULTIPLIER = 2
...
class GameSettings:
    ...
    def init():
        ...
        GameSettings.POINTSLEVEL_TARGETSCORE = POINTSLEVEL_TARGETSCORE
        GameSettings.BUBBLE_MAXDELTA_DELTA = BUBBLE_MAXDELTA_DELTA
        GameSettings.MULTIPLIERLEVEL_TARGETMULTIPLIER = MULTIPLIERLEVEL_TARGETMULTIPLIER
